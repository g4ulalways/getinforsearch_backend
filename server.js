...
async function callPerplexity(prompt, useOnline = true) {
  ...
  // Use NEW valid Perplexity model names (as of August 2025)
  const model = useOnline
    ? 'sonar-pro'     // Use the more powerful Pro model when online=true
    : 'sonar'         // Use the basic Sonar model otherwise
